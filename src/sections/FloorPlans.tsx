...
const floorPlans = [
  {
    ...
    area: '21.6??,
    rooms: '2??Âª?Ë°??ΩÂè∞',
    features: ['‰∏ªËá•ÂÆ?, 'Ê¨°Ëá•ÂÆ?, '?æ‰ª£Ë°õÊµ¥', '?ØË??ΩÂè∞'],
    image: '/images/room-a-living.jpg',
    roomImages: [
      { src: '/images/room-a-living.jpg', label: 'ÂÆ¢Âª≥', labelEn: 'LIVING' },
      { src: '/images/room-a-bedroom.jpg', label: '?•ÂÆ§', labelEn: 'BEDROOM' },
      { src: '/images/room-a-kitchen.jpg', label: 'ÂªöÊàø', labelEn: 'KITCHEN' },
      { src: '/images/room-a-bathroom.jpg', label: 'Ë°õÊµ¥', labelEn: 'BATHROOM' },
    ],
    details: {
      living: '?ãÊîæÂºèÂÆ¢È§êÂª≥ÔºåÈÄ???ØË??ΩÂè∞',
      master: '?íÈÅ©‰∏ªËá•ÔºåÈ?ÁΩÆÂ§ß?¢Êé°??,
      second: 'Â§öÂ??ΩÊ¨°?•Ô?Á©∫È??àÊ¥ª',
      kitchen: 'Á≤æÂ?ÂªöÂÖ∑ÔºåÈ??àÂ?Á∑öË???,
    },
  },
  {
    id: 'B',
    ...
    area: '19.08??,
    rooms: '1+1??Âª?Ë°??ΩÂè∞',
    features: ['Â§ßÈù¢?°Â?', '?ãÊîæÂºèÂ???, '?ØË??ΩÂè∞', 'ÂΩàÊÄßÁ©∫??],
    image: '/images/room-b-living.jpg',
    roomImages: [
      { src: '/images/room-b-living.jpg', label: 'ÂÆ¢Âª≥', labelEn: 'LIVING' },
      { src: '/images/room-b-bedroom.jpg', label: '?•ÂÆ§', labelEn: 'BEDROOM' },
      { src: '/images/room-b-kitchen.jpg', label: 'ÂªöÊàø', labelEn: 'KITCHEN' },
      { src: '/images/room-b-bathroom.jpg', label: 'Ë°õÊµ¥', labelEn: 'BATHROOM' },
    ],
    details: {
      living: 'ÂÆ¢È?Âª≥Â?‰∏ÄÔºåÊ•µÂ§ßÂ?Á©∫È???,
      master: '?úË?‰∏ªËá•Ôºå‰∫´?óÁ?Á≤π‰???,
      flexible: 'ÂΩàÊÄ?1Á©∫È?ÔºåÂèØ‰ΩúÊõ∏?øÊ?ÂÆ¢Êàø',
      kitchen: 'Á≤æÂ?ÂªöÊàøÔºåÁ≤æÂ∑ßÊ??ΩÁ?Â≠?,
    },
  },
];
    ...
    >
      ...
      <div className="relative z-10 w-full px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-text-secondary">3DÊ∏≤Ê??ÖÂ?Á§∫Ê??ñÔ?ÂØ¶È?‰ª•ÁèæÊ≥ÅÁÇ∫Ê∫?/p>
        </div>
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="p-8 border border-gold/30 bg-dark/50">
                ...
                <div className="flex items-center gap-6 pt-6 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-text-secondary">
                    ...
                    <span className="text-sm">{activePlan.id === 'A' ? '2 ?? : '1+1 ??}</span>
                  </div>
                  <div className="flex items-center gap-2 text-text-secondary">
                  ...
                  <div className="flex items-center gap-2 text-text-secondary">
                    ...
                    <span className="text-sm">1 Ë°?/span>
                  </div>
                  <div className="flex items-center gap-2 text-text-secondary">
                    <Wind className="w-5 h-5 text-gold/50" />
                    <span className="text-sm">1 ?ΩÂè∞</span>
                  </div>
                </div>
              </div>
              ...
              {/* Room details */}
              <div className="space-y-4">
                <h4 className="font-serif text-xl text-text-primary mb-4">Á©∫È?Ë¶èÂ?</h4>
